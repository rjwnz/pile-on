 ...
 */
export const VEHICLE_CSV_EXAMPLE = `id,name,kind,deck_length,deck_width,deck_height,tare,max_gross,balance_target,towable_by
...
TRAILER-4A,4-axle full trailer,full_trailer,8100,2450,1150,6800,22000,,RIGID-8
`;
